...
let test_zipper_of_list candidate =
  let b0 =
    ...
    let test_b0 =
      Diffcessible.Zipper.get_focus z = 1
  ...
  let b1 =
    ...
    try
      ...
      false
    with Diffcessible.Zipper.Empty_list -> true
  in
  b0 && b1
...
let test_next_zipper candidate =
  let b0 =
    ...
    try
      ...
      let test_b0 =
        Diffcessible.Zipper.get_focus next_z = 2
      ...
      in
      test_b0
    with Diffcessible.Zipper.Empty_list -> false
  in
  b0
...
let test_previous_zipper candidate =
  let b0 =
    ...
    try
      ...
      let test_b0 =
        Diffcessible.Zipper.get_focus previous_z = 2
